...
public class GetStartedSample {
	...
	private static String accessKeyId = "lOjSXZqd6NHJoajH";
	private static String accessKeySecret = "g0ynPG827tY1LzHmGdLpBwsXo1qBg7";
	private static String bucketName = "oss-mytest-s2";
